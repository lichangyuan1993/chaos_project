...
-- 1. 创建证件类型字典表
DROP TABLE IF EXISTS FFP.MASTER_DATE_IDENTITY_DOCUMENT_TYPE;
CREATE TABLE FFP.MASTER_DATE_IDENTITY_DOCUMENT_TYPE
(
...
-- 2. 插入初始枚举值
INSERT INTO FFP.MASTER_DATE_IDENTITY_DOCUMENT_TYPE (REC_ID, TYPE_CODE, TYPE_NAME, CREATE_USER, UPDATE_USER)
...
ALTER TABLE FFP.MEMBER_IDENTITY_DOCUMENT
    ADD CONSTRAINT FK_MID_ID_TYPE
        FOREIGN KEY (ID_TYPE) REFERENCES FFP.MASTER_DATE_IDENTITY_DOCUMENT_TYPE (TYPE_CODE);
...
VALUES ('3001', '1A1234GAS126', 'MEMBER_IDENTITY_DOCUMENT', '重生之参加抗日战争', 'pdf', 10, 0x0000),
       ('3002', '1A1234GAS126', 'MEMBER_IDENTITY_DOCUMENT', '重生之参加抗美援朝', 'pdf', 10, 0x0000),
       ('3003', '1A1234GAS127', 'MEMBER_IDENTITY_DOCUMENT', '重生之参加对越反击自卫战', 'pdf', 10, 0x0000);
